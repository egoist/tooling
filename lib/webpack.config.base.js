...
module.exports = function baseConfig(type, options) {
  ...
  if (type === 'watch') {
    ...
    const hmrClient = isElectron
      ? dir(`node_modules/webpack-hot-middleware/client?path=http://localhost:${options.port}/__webpack_hmr`)
      : dir('node_modules/webpack-hot-middleware/client')
    if (isElectron) {
